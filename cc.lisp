...
(defun edges-to-alist (edge-list)
  (mapcar (lambda (node1) (cons node1 (mapcar (lambda (edge) (list (cdr edge)))
	  ...
	  ((member 'wumpus node)
	   (if charging
	     ...
	     (has-worm (let ((new-pos (random-node)))
			 (princ "You ran into Glow Worm Gang! You are now at ")
			 (princ new-pos) (handle-new-place nil new-pos nil))))))
