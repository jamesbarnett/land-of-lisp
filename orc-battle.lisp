...
(defun orc-battle ()
  (init-monsters) (init-player) (game-loop)
  (when (player-dead)
...
(defun show-player ()
  (princ "You are valiant knight with a health of ")
  (princ *player-health*) (princ ", an agility of ")
  (princ *player-agility*) (princ ", and a strength of ")
...
(defun init-monsters ()
  (setf *monsters*
	(map 'vector
	     (lambda (x) (funcall (nth (random (length *monster-builders*))
				       *monster-builders*)))
...
(defmethod monster-attack ((m hydra))
  (let ((x (randval (ash (monster-health m) -1))))
    ...
    (incf (monster-health m)) (decf *player-health* x)))
